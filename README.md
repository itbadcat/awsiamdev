...
2. Configure the credentials required to access your AWS account as per [the boto3 documentation](https://boto3.amazonaws.com/v1/documentation/api/latest/guide/credentials.html). The initial IAM permissions required for script functionality are:
  ...
  - [access-analyzer:ListAnalyzers](https://docs.aws.amazon.com/access-analyzer/latest/APIReference/API_ListAnalyzers.html)
  - [access-analyzer:GetAnalyzer](https://docs.aws.amazon.com/access-analyzer/latest/APIReference/API_GetAnalyzer.html)
  - [access-analyzer:ListFindings](https://docs.aws.amazon.com/access-analyzer/latest/APIReference/API_ListFindings.html)
